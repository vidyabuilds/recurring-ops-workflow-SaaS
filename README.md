# Recurring Ops Workflow SaaS (Portfolio Project)
...
## Step 2 Artifacts (Discovery → Definition)
- Personas: [docs/research/personas.md](docs/research/personas.md)
- MVP Scope v1: [docs/roadmap/mvp-scope-v1.md](docs/roadmap/mvp-scope-v1.md)
- PRD v1: [docs/prd/prd-v1.md](docs/prd/prd-v1.md)
- Analytics Plan: [docs/analytics/event-tracking-plan.md](docs/analytics/event-tracking-plan.md)
- Prioritization (RICE/MoSCoW): [docs/roadmap/prioritization-v1.md](docs/roadmap/prioritization-v1.md)
